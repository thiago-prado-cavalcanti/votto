      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <div className="grid items-center gap-14 lg:grid-cols-[1.08fr_1fr] lg:gap-16">
          ...
          <Reveal>
            ...
            <h1 className="mt-5 font-display text-[2.9rem] font-medium leading-[0.99] tracking-[-0.026em] sm:text-6xl lg:text-[4.2rem]">
              ...
              <span className="block">
                ...
                <span className="relative inline-block">
                  democracia
                  {/* Grifo à mão, no lugar do sublinhado geométrico. */}
                  <svg
                    aria-hidden
                    viewBox="0 0 320 14"
            ...
            <p className="mt-8 max-w-xl text-base leading-relaxed text-navy-700 sm:text-lg">
          ...
          <Reveal>
            <AlignmentRadar className="mx-auto block h-auto w-full max-w-[30rem]" />
          </Reveal>
        </div>
