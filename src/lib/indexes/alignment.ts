...
// A regra de concordância vive num módulo puro (`agreement.ts`) e é reexportada
// daqui para os call sites existentes não mudarem. Uma definição, dois usuários.
import { MIN_ALIGNMENT_BASIS, pairAgreement, toScore } from "@/lib/indexes/agreement";

export { MIN_ALIGNMENT_BASIS, pairAgreement, toScore };
